...
router.route("/addplace").post(isAuthenticator,addPlace);
...
router.route("/updateplace/:Id").put(isAuthenticator,updatePlace);
router.route("/deleteplace/:Id").delete(isAuthenticator,deletePlace);
