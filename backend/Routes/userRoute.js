...
const { RegisterUser, LoginUser, Logout, forgotPassword, resetPassword, getUserProfile, UpdatePassword, UpdateProfile, getalluser, getSinglealluser, UpdateRole, DeleteUser } = require("../controller/userController");
