...
exports.forgotPassword = catcherror(async (req, res, next) => {
    ...
    const resetUrl = `${req.protocol}://${req.get("host")}/app/vr1/password/change/${resettoken}`;
...
exports.resetPassword = catcherror(async (req, res, next) => {
    ...
    if (req.body.password !== req.body.confirmPassword) {
        next(new ErrorHandler("Error: Password and Confirm Password should be same", 400));
    }
